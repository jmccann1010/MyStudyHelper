...
- Receive the feature from the Source Control Specialist.
...
**Outputs:** use AzureCLI https://dev.azure.com/SchneiderDowns/Jeff to create feature and user stories immediately; human-approval checkpoint; progress summaries; updates feature and user stories through AzureCLI on the board https://dev.azure.com/SchneiderDowns/Jeff.
